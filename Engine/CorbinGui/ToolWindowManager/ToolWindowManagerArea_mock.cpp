...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ToolWindowManagerArea_t, stringdata) + ofs \
...
const QMetaObject ToolWindowManagerArea::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_ToolWindowManagerArea.data,
      qt_meta_data_ToolWindowManagerArea,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ToolWindowManagerArea.stringdata))
        return static_cast<void*>(const_cast< ToolWindowManagerArea*>(this));
